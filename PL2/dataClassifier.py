...
def basicFeatureExtractorDigit(datum):
    ...
    print("dataClassifier: ", DIGIT_DATUM_WIDTH)
    print("dataClassifier: ", DIGIT_DATUM_HEIGHT)
    print("dataClassifier: ", datum)
...
def readCommand( argv ):
    ...
    if(options.classifier == "mostFrequent"):
        ...
        classifier = naiveBayes2.NaiveBayesClassifier(legalLabels)
...
def runClassifier(args, options):
    ...
    #print("dataClassifier: KrunClassifier")
